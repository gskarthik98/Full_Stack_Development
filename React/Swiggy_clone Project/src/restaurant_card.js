...
export const Card = (restaurant) => {
    ...
    return (<div className="w-96 h-[450px] m-4  p-4 hover:border bg-white shadow-2xl  hover:rounded-lg">
        <img  className="rounded-lg h-44 w-80 m-4  hover:opacity-75" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+res.cloudinaryImageId}/>
